...
async def test_pipeline_configs_and_stages():
    print("==================================================")
    print("🚀 [하네스 검증] 8단계 올인원 풀 라이프사이클 파이프라인 테스트")
    print("==================================================")
    ...
    # Check that full_cycle pipeline is properly registered with 8 stages
    ...
    assert data["stages_count"] == 8
    assert "올인원 풀 라이프사이클" in data["title"]
    print("  ✅ [PASS] 8단계 올인원 풀사이클(정우 ➡️ CEO ➡️ 민희 ➡️ 코다리 ➡️ 레오 ➡️ 찬우 ➡️ 지은 ➡️ 현빈) 정상 등록 검증 완료!")
